...
# ETL Procedure Runner Installs ETL procedures from SQL files in DWH_BUILD, Calls the master wrapper procedures that move data through layers

"""
    python procedure_runner.py install           
    python procedure_runner.py call                 
    python procedure_runner.py call --layer stg_cln  
"""
...
#  INSTALL ETL PROCEDURES  


ETL_INSTALL_PLAN = [
    # ── stg_cl procedures
    ("STG_CLN: load_stg_offline",         "stg_cln/stg_cln_procedure/load_stg_offline.sql"),
    ("STG_CLN: load_stg_online",          "stg_cln/stg_cln_procedure/load_stg_online.sql"),
    ("STG_CLN: load_stg_all",             "stg_cln/stg_cln_procedure/load_stg_all.sql"),
...
ETL_CALL_ORDER = [
    ("stg_cln",  "stg_cln.sp_load_stg_all"),

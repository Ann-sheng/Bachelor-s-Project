#retrived data from cloude and loads into the stg layer of DWH
"""
python staging_loader.py --load-type all
python staging_loader.py --source offline 
python staging_loader.py --force
"""
...
def load_parquet_to_staging(
    ...
    try:
        ...
        df_mapped["source_file"] = file_key  

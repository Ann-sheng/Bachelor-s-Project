...
CREATE TABLE IF NOT EXISTS bl_dm.dm_employees_scd (
    ...
    employee_store_branch_src_id   BIGINT          NOT NULL,  
    employee_store_branch_state    VARCHAR(50)     NOT NULL DEFAULT 'n. a.',
    employee_store_branch_city     VARCHAR(50)     NOT NULL DEFAULT 'n. a.',    

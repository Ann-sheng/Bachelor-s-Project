...
BEGIN
    ...
    IF v_start_date IS NULL THEN
        ...
        SET status = 'SUCCESS', rows_inserted = 0,
            finished_at = NOW(), error_message = 'No transactions - skipped'
    ...
    UPDATE bl_cn.etl_log
    SET status = 'SUCCESS', rows_inserted = v_total, finished_at = NOW()
    WHERE log_id = v_log_id;
...
EXCEPTION WHEN OTHERS THEN
    ...
    WHERE log_id = v_log_id;
    RAISE EXCEPTION '[load_dim_dates] FAILED: %', v_err_msg;
END;
$$;
